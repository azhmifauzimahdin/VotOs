            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row d-flex justify-content-between mb-3 mx-0">
                        <a href="/dashboard/pemilih/kelas/create" class="btn btn-primary">
                        ...
                        <ul class="list-inline mb-0 mt-2 mt-md-0">
                            ...
                            <li class="list-inline-item">
                                <form action="/dashboard/pemilih/kelas" class="input-search">
                            ...
                            <tbody>
                                @if (count($kelas))
                                    @foreach ($kelas as $index => $data)
                                        <tr>
                                            <td class="w-10">{{ $index + $kelas->firstItem() }}</td>
                                            <td class="w-90">{{ $data->nama }}</td>
                                            <td class="text-nowrap">
                                                <a href="/dashboard/pemilih/kelas/{{ $data->slug }}/edit" class="btn btn-sm bg-warning">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                                @if (!$waktupemilu) 
                                                <form action="/dashboard/pemilih/kelas/{{ $data->slug }}" name="formDeletee" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf 
